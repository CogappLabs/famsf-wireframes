...
const SAMPLE_CART = objects.filter((o) => o.copyrightStatus === "in-copyright");
								...
								{SAMPLE_CART.map((w) => (
									...
									>
										<div className="w-20 shrink-0">
											<ImagePlaceholder aspect="1/1" label={`[${w.title}]`} />
										</div>
										<div className="flex-1">
											...
											<p className="font-mono text-label text-gray-400">
												{w.accession} &middot;{" "}
												{w.copyrightHolder ?? "Copyright unknown"}
											</p>
										</div>
										<button
											type="button"
