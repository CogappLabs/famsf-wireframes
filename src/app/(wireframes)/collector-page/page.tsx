...
export default function CollectorPage() {
	// Sample: Alma Spreckels
	const collectorObjects = objects.filter(
		(o) => o.creditLine.includes("Spreckels") || o.creditLine.includes("Alma"),
	);
	// Show related objects even if credit line doesn't match sample data
	const displayObjects =
		collectorObjects.length > 0 ? collectorObjects : objects.slice(0, 6);
				...
				>
					<Container>
						...
						<p className="mt-1 font-mono text-body text-gray-500">
							1881\u20131968 &middot; Founder, California Palace of the Legion
							of Honor
						</p>
