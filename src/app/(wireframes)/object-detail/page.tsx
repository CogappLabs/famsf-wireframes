			...
			<div className="min-h-screen bg-white">
				...
				>
					<Container>
						<ImagePlaceholder
							aspect="16/9"
							label={`[${obj.title} \u2014 high-res, zoomable (IIIF deep zoom)]`}
						...
						{/* Thumbnail strip — each thumb declares its alt text */}
						<div className="mt-3 flex gap-2">
							{(obj.images && obj.images.length > 0
								...
								<div
									...
									className={
										i === 0
											? "w-20 border-2 border-gray-900"
											: "w-20 border border-gray-300"
									}
						...
						<WireframeSection label="Tombstone">
							<div className="flex flex-col gap-3">
								...
								{(obj.keywords?.length ||
									...
									obj.style ||
									obj.movement) && (
									<ScopeMark label="Attributes">
										<div className="mt-3 border-t border-gray-200 pt-3">
											<SectionLabel className="mb-2">
												{t("object.attributesHeading")}
											</SectionLabel>
							...
							<div className="flex flex-col gap-3">
								<div className="flex items-center gap-4 border border-gray-300 p-4">
									...
									<div>
										...
										<p className="font-mono text-meta text-gray-500">
											Grades 6\u201312 &middot; 2\u20133 class periods
										</p>
									</div>
								</div>
								<Link
