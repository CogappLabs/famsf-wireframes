		...
		<div className="min-h-screen bg-white">
			...
			>
				<Container>
					...
					<h1 className="mt-1 font-mono text-page text-gray-900">
						Schema Reference
					</h1>
					<p className="mt-2 max-w-3xl font-mono text-meta text-gray-700">
					...
					<div className="mt-6 grid grid-cols-2 gap-4 sm:grid-cols-5">
						<div className="border border-gray-300 p-3">
							<div className="font-mono text-section text-gray-900">
								{data.field_count}
							</div>
						...
						<div className="border border-gray-300 p-3">
							<div className="font-mono text-section text-gray-700">
								{data.passthrough_count}
							</div>
							<SectionLabel>Passthrough</SectionLabel>
						</div>
						<div className="border border-gray-300 p-3">
							<div className="font-mono text-section text-amber-700">
								{data.derived_count}
							</div>
							<SectionLabel>Derived</SectionLabel>
						</div>
						<div className="border border-gray-300 p-3">
							<div className="font-mono text-section text-purple-700">
