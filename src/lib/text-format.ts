...
/** Cataloguing guideline ("Date"): en dash between year-like tokens in
 *  date ranges, not hyphen. Replaces ` - ` / `-` between 3-4 digit
 *  numbers with ` – `. Safe on non-range strings (no-op). */
